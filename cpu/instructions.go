...
// 2019-07-14 02:40:37.004851388 -0300 -03 m=+0.007649378
package cpu
...
func gbLDrnB(cpu *Core) {
	cpu.Registers.B = cpu.Memory.ReadByteForPC(cpu.Registers.PC)
	cpu.Registers.PC++
	cpu.Registers.LastClockM = 2
	cpu.Registers.LastClockT = 8
}
...
func gbLDrnC(cpu *Core) {
	cpu.Registers.C = cpu.Memory.ReadByteForPC(cpu.Registers.PC)
	cpu.Registers.PC++
	cpu.Registers.LastClockM = 2
	cpu.Registers.LastClockT = 8
}
...
func gbLDrnD(cpu *Core) {
	cpu.Registers.D = cpu.Memory.ReadByteForPC(cpu.Registers.PC)
	cpu.Registers.PC++
	cpu.Registers.LastClockM = 2
	cpu.Registers.LastClockT = 8
}
...
func gbLDrnE(cpu *Core) {
	cpu.Registers.E = cpu.Memory.ReadByteForPC(cpu.Registers.PC)
	cpu.Registers.PC++
	cpu.Registers.LastClockM = 2
	cpu.Registers.LastClockT = 8
}
...
func gbLDrnH(cpu *Core) {
	cpu.Registers.H = cpu.Memory.ReadByteForPC(cpu.Registers.PC)
	cpu.Registers.PC++
	cpu.Registers.LastClockM = 2
	cpu.Registers.LastClockT = 8
}
...
func gbLDrnL(cpu *Core) {
	cpu.Registers.L = cpu.Memory.ReadByteForPC(cpu.Registers.PC)
	cpu.Registers.PC++
	cpu.Registers.LastClockM = 2
	cpu.Registers.LastClockT = 8
}
...
func gbLDmmA(cpu *Core) {
	cpu.Memory.WriteByte(cpu.Memory.ReadWordForPC(cpu.Registers.PC), cpu.Registers.A)
	cpu.Registers.PC += 2
...
// gbPOPAF Reads A and F from the Stack
func gbPOPAF(cpu *Core) {
	...
	if "F" == "F" {
		cpu.Registers.F &= 0xF0 // Clear lower nibble from Flag
	}
...
// gbPOPBC Reads B and C from the Stack
func gbPOPBC(cpu *Core) {
	...
	if "C" == "F" {
		cpu.Registers.C &= 0xF0 // Clear lower nibble from Flag
	}
...
// gbPOPDE Reads D and E from the Stack
func gbPOPDE(cpu *Core) {
	...
	if "E" == "F" {
		cpu.Registers.E &= 0xF0 // Clear lower nibble from Flag
	}
...
// gbPOPHL Reads H and L from the Stack
func gbPOPHL(cpu *Core) {
	...
	if "L" == "F" {
		cpu.Registers.L &= 0xF0 // Clear lower nibble from Flag
	}
