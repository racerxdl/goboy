...
// 2019-06-19 21:30:36.931313354 -0300 -03 m=+0.009633774
package cpu
...
// gbADCA Sets A to A + A + FlagCarry
func gbADCA(cpu *Core) {
...
// gbADCB Sets A to A + B + FlagCarry
func gbADCB(cpu *Core) {
...
// gbADCC Sets A to A + C + FlagCarry
func gbADCC(cpu *Core) {
...
// gbADCD Sets A to A + D + FlagCarry
func gbADCD(cpu *Core) {
...
// gbADCE Sets A to A + E + FlagCarry
func gbADCE(cpu *Core) {
...
// gbADCH Sets A to A + H + FlagCarry
func gbADCH(cpu *Core) {
...
// gbADCL Sets A to A + L + FlagCarry
func gbADCL(cpu *Core) {
...
// gbADCF Sets A to A + F + FlagCarry
func gbADCF(cpu *Core) {
...
// gbSBCA Sets A to A - A - FlagCarry
func gbSBCA(cpu *Core) {
	b := int(cpu.Registers.A)
	f := 0
	if cpu.Registers.GetCarry() {
		f = 1
...
// gbSBCB Sets A to A - B - FlagCarry
func gbSBCB(cpu *Core) {
	b := int(cpu.Registers.B)
	f := 0
	if cpu.Registers.GetCarry() {
		f = 1
...
// gbSBCC Sets A to A - C - FlagCarry
func gbSBCC(cpu *Core) {
	b := int(cpu.Registers.C)
	f := 0
	if cpu.Registers.GetCarry() {
		f = 1
...
// gbSBCD Sets A to A - D - FlagCarry
func gbSBCD(cpu *Core) {
	b := int(cpu.Registers.D)
	f := 0
	if cpu.Registers.GetCarry() {
		f = 1
...
// gbSBCE Sets A to A - E - FlagCarry
func gbSBCE(cpu *Core) {
	b := int(cpu.Registers.E)
	f := 0
	if cpu.Registers.GetCarry() {
		f = 1
...
// gbSBCH Sets A to A - H - FlagCarry
func gbSBCH(cpu *Core) {
	b := int(cpu.Registers.H)
	f := 0
	if cpu.Registers.GetCarry() {
		f = 1
...
// gbSBCL Sets A to A - L - FlagCarry
func gbSBCL(cpu *Core) {
	b := int(cpu.Registers.L)
	f := 0
	if cpu.Registers.GetCarry() {
		f = 1
...
// gbSBCF Sets A to A - F - FlagCarry
func gbSBCF(cpu *Core) {
	b := int(cpu.Registers.F)
	f := 0
	if cpu.Registers.GetCarry() {
		f = 1
