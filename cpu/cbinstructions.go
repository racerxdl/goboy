...
// 2019-07-14 02:40:37.021871109 -0300 -03 m=+0.024669117
package cpu
...
func cbBIT0A(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.A & uint8(1<<0)) == 0)
	cpu.Registers.SetSub(false)
...
func cbBIT1A(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.A & uint8(1<<1)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT2A(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.A & uint8(1<<2)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT3A(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.A & uint8(1<<3)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT4A(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.A & uint8(1<<4)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT5A(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.A & uint8(1<<5)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT6A(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.A & uint8(1<<6)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT7A(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.A & uint8(1<<7)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT0B(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.B & uint8(1<<0)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT1B(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.B & uint8(1<<1)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT2B(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.B & uint8(1<<2)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT3B(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.B & uint8(1<<3)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT4B(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.B & uint8(1<<4)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT5B(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.B & uint8(1<<5)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT6B(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.B & uint8(1<<6)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT7B(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.B & uint8(1<<7)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT0C(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.C & uint8(1<<0)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT1C(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.C & uint8(1<<1)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT2C(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.C & uint8(1<<2)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT3C(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.C & uint8(1<<3)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT4C(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.C & uint8(1<<4)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT5C(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.C & uint8(1<<5)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT6C(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.C & uint8(1<<6)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT7C(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.C & uint8(1<<7)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT0D(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.D & uint8(1<<0)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT1D(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.D & uint8(1<<1)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT2D(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.D & uint8(1<<2)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT3D(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.D & uint8(1<<3)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT4D(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.D & uint8(1<<4)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT5D(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.D & uint8(1<<5)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT6D(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.D & uint8(1<<6)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT7D(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.D & uint8(1<<7)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT0E(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.E & uint8(1<<0)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT1E(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.E & uint8(1<<1)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT2E(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.E & uint8(1<<2)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT3E(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.E & uint8(1<<3)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT4E(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.E & uint8(1<<4)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT5E(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.E & uint8(1<<5)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT6E(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.E & uint8(1<<6)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT7E(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.E & uint8(1<<7)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT0H(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.H & uint8(1<<0)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT1H(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.H & uint8(1<<1)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT2H(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.H & uint8(1<<2)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT3H(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.H & uint8(1<<3)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT4H(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.H & uint8(1<<4)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT5H(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.H & uint8(1<<5)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT6H(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.H & uint8(1<<6)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT7H(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.H & uint8(1<<7)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT0L(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.L & uint8(1<<0)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT1L(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.L & uint8(1<<1)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT2L(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.L & uint8(1<<2)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT3L(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.L & uint8(1<<3)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT4L(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.L & uint8(1<<4)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT5L(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.L & uint8(1<<5)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT6L(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.L & uint8(1<<6)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
...
func cbBIT7L(cpu *Core) {
	cpu.Registers.SetZero((cpu.Registers.L & uint8(1<<7)) == 0)
	cpu.Registers.SetSub(false)
	cpu.Registers.SetHalfCarry(true)
